# Autogenerated using ProtoBuf.jl v1.0.7 on 2022-10-11T13:52:28.061
# original file: /Users/arhik/October2022/IPFS.jl/src/protos/ipld.proto (proto2 syntax)
...
function PB._encoded_size(x::PBLink)
    ...
    (encoded_size += PB._encoded_size(x.Name, 2))
...
function PB.encode(e::PB.AbstractProtoEncoder, x::PBNode)
    initpos = position(e.io)
    !isempty(x.Links) &&   			for el in x.Links
    			PB.encode(e, 2, el)
 		   	end
