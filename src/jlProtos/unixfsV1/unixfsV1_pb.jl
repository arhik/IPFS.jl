# Autogenerated using ProtoBuf.jl v1.0.7 on 2022-10-11T13:52:28.292
# original file: /Users/arhik/October2022/IPFS.jl/src/protos/unixfsV1.proto (proto2 syntax)

import ProtoBuf as PB
using ProtoBuf: OneOf
using EnumX: @enumx

export var"Data.DataType", Metadata, Data
...
PB.default_values(::Type{Data}) = (;var"#Type" = var"Data.DataType".Raw, ByteData = UInt8[], filesize = zero(UInt64), blocksizes = Vector{UInt64}(), hashType = zero(UInt64), fanout = zero(UInt64))
PB.field_numbers(::Type{Data}) = (;var"#Type" = 1, ByteData = 2, filesize = 3, blocksizes = 4, hashType = 5, fanout = 6)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Data})
    ...
    while !PB.message_done(d)
        ...
        elseif field_number == 2
            ByteData = PB.decode(d, Vector{UInt8})
...
function PB._encoded_size(x::Data)
    ...
    !isempty(x.ByteData) && (encoded_size += PB._encoded_size(x.ByteData, 2))
