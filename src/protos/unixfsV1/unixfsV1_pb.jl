# Autogenerated using ProtoBuf.jl v1.0.7 on 2022-10-08T23:44:39.115
...
PB.default_values(::Type{Data}) = (;var"#Type" = var"Data.DataType".Raw, ByteData = UInt8[], filesize = zero(UInt64), blocksizes = Vector{UInt64}(), hashType = zero(UInt64), fanout = zero(UInt64), mode = zero(UInt32), mtime = nothing)
PB.field_numbers(::Type{Data}) = (;var"#Type" = 1, ByteData = 2, filesize = 3, blocksizes = 4, hashType = 5, fanout = 6, mode = 7, mtime = 8)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Data})
    ...
    return Data(var"#Type", ByteData, filesize, blocksizes[], hashType, fanout, mode, mtime[])
end
